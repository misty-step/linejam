    ...
    >
      ...
      >
        <div className="w-full max-w-xl">
          ...
          <h1 className="mb-8 text-4xl font-[var(--font-display)] leading-tight md:text-6xl">
            Host Session
          </h1>
      ...
      <div
        ...
        className="lj-safe-inline min-h-0 max-h-1/2 flex-[0_1_auto] overflow-y-auto border-t-2 border-primary/20 bg-background/95 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[var(--shadow-lg)] backdrop-blur-md md:[--lj-safe-inline-space:3rem] lg:[--lj-safe-inline-space:5rem]"
      >
