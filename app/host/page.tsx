  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="lj-safe-inline max-h-1/2 flex-none overflow-y-auto border-t-2 border-primary/20 bg-background/95 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[var(--shadow-lg)] backdrop-blur-md md:[--lj-safe-inline-space:3rem] lg:[--lj-safe-inline-space:5rem]"
      >
