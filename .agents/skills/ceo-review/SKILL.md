...
would fail _differently_ from the others. If all three fail the same way,
they're the same plan.

### 3. Outside Voice

Consult a different _foundation_, not a different persona.
...
- **Premise-challenge theater.** Asking "is this the right problem?" and
  ...
  state _what specifically survived_ the audit — otherwise you didn't do it.
