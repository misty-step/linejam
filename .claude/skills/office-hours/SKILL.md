...
Who specifically wants this, and how do you know? Not "users" — _which_
...
- **Answering your own questions.** "Probably" and "I think" are speculation,
  ...
  pressure-tests it.
- **Accepting "users want it."** _Users_ is a cop-out. Which users, when,
...
- **Future-fit as disqualifier.** "Will be obsolete in 3 years" is not
  always disqualifying — tactical patches are fine if _named_ as such. The
...
- **`/ceo-review`** is the post-shape counterpart. Office hours sharpens
  the _problem_; CEO review challenges the _plan_.
