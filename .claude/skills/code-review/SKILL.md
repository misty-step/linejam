...
2. **Select internal reviewers (static map).** Run the algorithm in
   ...
   Only agents that exist in `/Users/phaedrus/Development/spellbook/agents/`
...
from `/Users/phaedrus/Development/linejam/.claude/repo-brief.md` — cite
...
- **Invariant #5 — Mocking boundary.** Reject any test that mocks `@/` or
  ...
  load-bearing for slice 014's mock-boundary ESLint rule.
