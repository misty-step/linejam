...
- Delegate audit, remediation, and critique to separate focused
  ...
  (references at
  `/Users/phaedrus/Development/spellbook/agents/a11y-*.md`).
...
(`/Users/phaedrus/Development/spellbook/agents/a11y-auditor.md`). It
...
(`/Users/phaedrus/Development/spellbook/agents/a11y-fixer.md`) with the
...
(`/Users/phaedrus/Development/spellbook/agents/a11y-critic.md`). **No
