...
- Delegate artifact validation and log tailing to subagents
  (`/Users/phaedrus/Development/spellbook/agents/builder.md` for tool
  invocation, `/Users/phaedrus/Development/spellbook/agents/critic.md`
...
- `/Users/phaedrus/Development/linejam/package.json` (`build`,
  `generate:releases` scripts)
- `/Users/phaedrus/Development/linejam/fly.responder.toml` (Fly app)
- `/Users/phaedrus/Development/linejam/Dockerfile.responder` (responder
  container)
- `/Users/phaedrus/Development/linejam/scripts/ci/bootstrap-convex-env.mjs`
  (hosted Convex deploy mode resolution)
- `/Users/phaedrus/Development/linejam/.github/workflows/release.yml`
...
- `/Users/phaedrus/Development/linejam/.claude/repo-brief.md` — shared
  spine; cite Invariants #1, #3, #4, #8 verbatim when justifying
  refusals.
- `/Users/phaedrus/Development/linejam/scripts/ci/bootstrap-convex-env.mjs`
  — deploy mode resolution, env parity seeding.
- `/Users/phaedrus/Development/linejam/Dockerfile.responder` +
  `/Users/phaedrus/Development/linejam/fly.responder.toml` — responder
  container + Fly config.
- `/Users/phaedrus/Development/linejam/.github/workflows/release.yml`
  — semantic-release pipeline.
- `/Users/phaedrus/Development/linejam/docs/deployment.md` — detailed
  setup (env provisioning, first-time webhook registration, rotation).
- `/Users/phaedrus/Development/linejam/docs/adr/0001-hybrid-auth-signed-guest-tokens.md`
  — why `GUEST_TOKEN_SECRET` parity is load-bearing and why Clerk JWT
  template pre-creation matters.
- `/Users/phaedrus/Development/spellbook/agents/builder.md` — for
  delegating CLI invocations.
- `/Users/phaedrus/Development/spellbook/agents/critic.md` — for
