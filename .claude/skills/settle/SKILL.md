...
Before touching anything, cross-check the in-flight CI redesign (SHAPE-E promotion
gate, `docs/ci/redesign-2026Q2.md`, slices 010–015):

- **Slice 010 (preview lane)** and **014 (convex-test + mock-boundary lint)**
  are the ready/independent slices. Do not settle a PR that reshapes the
  preview-lane contract unless it is slice 010 itself. Coordinate with the
  user if you think you're colliding.
- Slices **011, 012, 013** serialize on 010. If you find yourself landing one
  of those ahead of 010, stop and confirm.
- **015** (ornamental-lane trim) lands last.
...
5. **CI-redesign collision check**: if this PR touches preview-lane scaffolding
   (`docs/ci/redesign-2026Q2.md`, `dagger/src/index.ts` preview lanes) and is
   not itself slice 010, stop and confirm with the user.
...
`/Users/phaedrus/Development/spellbook/agents/`):
